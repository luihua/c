...
title('original line and reconstructed line ')
xlabel('X')
ylabel('Y')
legend
grid on
subplot(2, 1, 2)
plot(x_fine,  k_fx_fine, 'g-', 'DisplayName', 'the curvatures of original line')
hold on
scatter(x_samples,  k_fx, 'filled', 'r', 'DisplayName', 'the curvatures of the sampling points')
title('the distribution of curvature')
xlabel('X')
ylabel('y')
legend
grid on
